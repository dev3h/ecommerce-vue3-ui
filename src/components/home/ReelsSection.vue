    ...
    <section class="mb-8 sm:mb-12">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-4 sm:mb-6">
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white px-3 py-1 rounded-full text-xs font-medium">
            ...
            >
                ...
                <div class="absolute top-2 left-2">
                    <div class="relative">
                        ...
                        />
                        <div v-if="reel.creator.is_verified" class="absolute -bottom-1 -right-1 bg-blue-500 rounded-full p-0.5">
                ...
                <div class="absolute top-2 right-2 flex flex-col items-end gap-1">
                    <div class="flex items-center gap-1 text-white text-xs bg-black/50 rounded-full px-2 py-1">
                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-2">
                    ...
                    <!-- Product Badge -->
                    <div v-if="reel.product" class="flex items-center gap-1 bg-white/90 rounded-full px-2 py-1 w-fit">
                        <img :src="reel.product.image" :alt="reel.product.name" class="w-4 h-4 rounded-full object-cover"/>
                        <span class="text-black text-xs font-medium">{{ formatPrice(reel.product.price) }}</span>
                    </div>
                </div>
