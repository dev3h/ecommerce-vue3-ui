<template>
    ...
    >
        ...
        <div
            ...
            class="flex justify-center items-center h-full text-white text-center"
        >
            <div>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <HeartIcon v-else class="w-7 h-7" />
                ...
                <div
                    v-if="!isMobile"
                    class="absolute left-4 top-1/2 transform -translate-y-1/2 flex flex-col gap-2 z-10"
                >
                    <div
                        v-for="(_, idx) in reels.slice(
...
const { t } = useAppI18n()
const { reels, isLoading, hasMore, loadReels, loadMore, toggleLike, shareReel, addView } =
    useReels()
