<template>
    <Card class="mt-8">
        <CardHeader>
            <CardTitle class="text-2xl font-bold">{{ t('admin.updatePassword') }}</CardTitle>
            <CardDescription>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                <div class="space-y-2">
                    <Label for="currentPassword"
                        >{{ t('admin.currentPassword') }}<span class="text-red-500">*</span></Label
                    >
                    <Input
                        id="currentPassword"
                ...
                <div class="space-y-2">
                    <Label for="newPassword"
                        >{{ t('admin.newPassword') }}<span class="text-red-500">*</span></Label
                    >
                    <Input
                        id="newPassword"
                ...
                <div class="space-y-2">
                    <Label for="confirmPassword"
                        >{{ t('admin.confirmPassword') }}<span class="text-red-500">*</span></Label
                    >
                    <Input
                        id="confirmPassword"
